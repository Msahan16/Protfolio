...
const About = () => {
      ...
      {skills.map((skill, i) => (
        <li key={i}>
          <div className="skill-line">
            ...
            {/* ✅ Percentage moved OUTSIDE progress bar */}
  ...
  return (
    <section id="about" className="about">
      ...
      {/* Logos Marquee on top of About Me title */}
    ...
    <img src={awsLogo} alt="AWS" />
      ...
      <div className="about-content">
        <div className="about-text">
          ...
          <p>I hold a Bachelor of Engineering in Computer Software Engineering and certifications in WordPress, cybersecurity, and ticketing systems.</p>
        </div>
